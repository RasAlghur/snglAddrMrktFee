...
contract WEENER is ERC20, Ownable {
    uint256 public feeOnBuy = 5;
    uint256 public feeOnSell = 5;
    address public marketingWallet = 0xA27B89672557472BAD3c1859E25BA2086cCb0dBc;
    address public devWallet = 0xb8b92F06aEFE59012B6D406D6dB7dC33FFc8ECFc;
    ...
    constructor(address initialOwner, address _v2Router) ERC20("WEENER RENEEW", "WEENER") Ownable(initialOwner) {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            _v2Router
        );
            // 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D // UNI
            // 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 // PCS_TEST
