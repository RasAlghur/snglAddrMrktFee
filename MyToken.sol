...
contract MyToken is ERC20, Ownable {
    uint256 public constant feeOnBuy = 3;
    uint256 public constant feeOnSell = 3;
    ...
    constructor(address _devWallet, address _marketingWallet, uint256 _totalSupply, string memory _name, string memory _symbol, uint8 _decimals)
    ...
    function swapBack() private {
        ...
        sendBNB(payable(marketingWallet), contractTokenBalance);
    }
    ...
    function transferForeignToken(address _token) external returns (bool _sent) {
        ...
        _sent = IERC20(_token).transfer(address(marketingWallet), _contractBalance);
